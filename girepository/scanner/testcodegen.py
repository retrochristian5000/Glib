            ...
            func = girast.Function(
                ...
                [
                    girast.Parameter(
                        "arg0",
                        typeval,
                        transfer=girast.PARAM_TRANSFER_NONE,
                        direction=girast.PARAM_DIRECTION_IN,
                    )
                ],
                False,
                sym,
            ...
            func = girast.Function(
                ...
                [
                    girast.Parameter(
                        ...
                        typeval,
                        transfer=girast.PARAM_TRANSFER_NONE,
                        direction=girast.PARAM_DIRECTION_OUT,
                    )
                ],
                False,
                sym,
