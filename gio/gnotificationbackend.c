...
/**
 * g_notification_backend_get_application:
 *
 * Returns: (transfer full) (nullable):
 *  The application object this notification backend handles notifications for.
 */
GApplication *
g_notification_backend_get_application (GNotificationBackend *self)
{
                                     ...
                                     GParamSpec *pspec)
{
  ...
  switch ((GNotificationBackendProperty) prop_id)
    ...
    case PROP_APPLICATION:
      {
        g_value_take_object (value, g_notification_backend_get_application (self));
        break;
      }
    default:
